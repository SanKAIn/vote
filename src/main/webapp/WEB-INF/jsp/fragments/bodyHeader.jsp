...
<nav class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    <div class="container">
        <a href="voting" class="navbar-brand"><img src="resources/images/icon.png"> Voting </a>
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="form-inline my-2" action="logout" method="post">
                            <sec:authorize access="hasRole('ADMIN')">
                                <a class="btn btn-info mr-1" href="/restaurants">Restaurants</a>
                                <a class="btn btn-info mr-1" href="/users">Users</a>
                            </sec:authorize>
                            <a class="btn btn-info mr-1" href="/history">History</a>
