...
import ru.alex.myvote.util.UserUtil;
import ru.alex.myvote.web.SecurityUtil;

import java.util.List;

import static ru.alex.myvote.util.UserUtil.prepareToSave;
import static ru.alex.myvote.util.ValidationUtil.checkNotFound;
